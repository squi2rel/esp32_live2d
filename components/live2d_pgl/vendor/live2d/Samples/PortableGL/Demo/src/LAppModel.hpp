...
public:
    ...
    */
     ...
     */
    Csm::Rendering::CubismRenderTarget_PortableGL& GetRenderBuffer();
...
private:
    ...
    */
    ...
    Csm::Rendering::CubismRenderTarget_PortableGL _renderBuffer;   ///< フレームバッファ以外の描画先
    std::vector<std::string> _ownedTextureFiles; ///< このモデルが保持しているテクスチャ
};
